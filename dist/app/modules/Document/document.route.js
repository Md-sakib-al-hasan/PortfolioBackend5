...
router.patch('/update-blog/', (0, validateRequest_1.default)(document_validation_1.DocumentValidations.BlogUpdateSchema), document_controller_1.DocumentControllers.UpdateDcoment);
router.delete('/delete-blog/', document_controller_1.DocumentControllers.DeletesingelDocument);
router.get('/getsingle-blog/', document_controller_1.DocumentControllers.getsingleDocument);
